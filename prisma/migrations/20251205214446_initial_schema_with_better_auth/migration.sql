-- CreateEnum
CREATE TYPE "WidgetType" AS ENUM ('weather', 'clock', 'date', 'quote', 'notes', 'color_generator');
...
-- CreateIndex
CREATE UNIQUE INDEX "widgets_dashboardId_order_key" ON "widgets"("dashboardId", "order");
